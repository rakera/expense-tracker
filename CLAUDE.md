...
- `pages/` — one slice per route (`login`, `register`, `dashboard`, `transactions`, `expenses`, `categories`, `not-found`). Pages compose widgets/features/entities and hold no business logic.
